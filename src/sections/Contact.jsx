...
const Contact = () => {
	...
	return (
		<section className='c-space my-20' id='contact'>
			...
			<div className='relative min-h-screen overflow-hidden flex items-center justify-center flex-col'>
				<img src='/assets/terminal.png' alt='terminal-bg' className='absolute inset-0 min-h-screen' />

				<div className='contact-container'>
					<h3 className='head-text mt-5 xl:mt-20 '>Let's talk</h3>
					...
					<form ref={formRef} onSubmit={handleSubmit} className='mt-7 flex flex-col space-y-7'>
						...
						<label className='space-y-3'>
							...
							<textarea
								...
								rows={5}
								className='field-input'
								placeholder='Hi Abdelrahman I wann Hire You Now.'
							/>
						</label>
